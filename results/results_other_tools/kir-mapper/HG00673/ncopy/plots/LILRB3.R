	...
	ggsave("results/HG00673//ncopy//plots//LILRB3.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG00673//ncopy//plots//LILRB3.html', selfcontained = F, libdir = 'results/HG00673//ncopy//plots//LILRB3')