	...
	ggsave("results/HG03486//ncopy//plots//5UPKIR.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG03486//ncopy//plots//5UPKIR.html', selfcontained = F, libdir = 'results/HG03486//ncopy//plots//5UPKIR')