	...
	ggsave("results/HG03486//ncopy//plots//LILRB1.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG03486//ncopy//plots//LILRB1.html', selfcontained = F, libdir = 'results/HG03486//ncopy//plots//LILRB1')