	...
	ggsave("results/HG02145//ncopy//plots//KIR2DL4.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG02145//ncopy//plots//KIR2DL4.html', selfcontained = F, libdir = 'results/HG02145//ncopy//plots//KIR2DL4')