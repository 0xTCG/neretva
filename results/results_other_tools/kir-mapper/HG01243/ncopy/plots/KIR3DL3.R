	...
	ggsave("results/HG01243//ncopy//plots//KIR3DL3.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG01243//ncopy//plots//KIR3DL3.html', selfcontained = F, libdir = 'results/HG01243//ncopy//plots//KIR3DL3')