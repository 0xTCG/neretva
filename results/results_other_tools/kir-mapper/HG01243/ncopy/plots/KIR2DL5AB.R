	...
	setwd('results/HG01243//ncopy//plots/')
	...
	ggsave("results/HG01243//ncopy//plots//KIR2DL5AB.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG01243//ncopy//plots//KIR2DL5AB.html', selfcontained = F, libdir = 'results/HG01243//ncopy//plots//KIR2DL5AB')