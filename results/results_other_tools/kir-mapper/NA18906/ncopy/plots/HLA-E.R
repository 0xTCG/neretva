	...
	ggsave("results/NA18906//ncopy//plots//HLA-E.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/NA18906//ncopy//plots//HLA-E.html', selfcontained = F, libdir = 'results/NA18906//ncopy//plots//HLA-E')