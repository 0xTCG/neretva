	...
	ggsave("results/NA18906//ncopy//plots//HLA-G.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/NA18906//ncopy//plots//HLA-G.html', selfcontained = F, libdir = 'results/NA18906//ncopy//plots//HLA-G')