	...
	ggsave("results/HG00735//ncopy//plots//KIR3DL2.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG00735//ncopy//plots//KIR3DL2.html', selfcontained = F, libdir = 'results/HG00735//ncopy//plots//KIR3DL2')