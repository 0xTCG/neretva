	...
	ggsave("results/HG01928//ncopy//plots//HLA-G.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG01928//ncopy//plots//HLA-G.html', selfcontained = F, libdir = 'results/HG01928//ncopy//plots//HLA-G')