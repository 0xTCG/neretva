	...
	ggsave("results/HG00733//ncopy//plots//KIR3DL3.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG00733//ncopy//plots//KIR3DL3.html', selfcontained = F, libdir = 'results/HG00733//ncopy//plots//KIR3DL3')