	...
	ggsave("results/HG02572//ncopy//plots//HLA-E.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG02572//ncopy//plots//HLA-E.html', selfcontained = F, libdir = 'results/HG02572//ncopy//plots//HLA-E')