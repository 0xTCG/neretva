	...
	ggsave("results/HG02572//ncopy//plots//HLA-G.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG02572//ncopy//plots//HLA-G.html', selfcontained = F, libdir = 'results/HG02572//ncopy//plots//HLA-G')