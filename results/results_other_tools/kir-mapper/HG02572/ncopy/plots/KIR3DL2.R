	...
	ggsave("results/HG02572//ncopy//plots//KIR3DL2.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG02572//ncopy//plots//KIR3DL2.html', selfcontained = F, libdir = 'results/HG02572//ncopy//plots//KIR3DL2')