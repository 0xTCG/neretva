	...
	ggsave("results/NA19030//ncopy//plots//KIR3DP1.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/NA19030//ncopy//plots//KIR3DP1.html', selfcontained = F, libdir = 'results/NA19030//ncopy//plots//KIR3DP1')