	...
	ggsave("results/NA19030//ncopy//plots//LILRB1.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/NA19030//ncopy//plots//LILRB1.html', selfcontained = F, libdir = 'results/NA19030//ncopy//plots//LILRB1')