	...
	ggsave("results/NA19030//ncopy//plots//HLA-E.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/NA19030//ncopy//plots//HLA-E.html', selfcontained = F, libdir = 'results/NA19030//ncopy//plots//HLA-E')