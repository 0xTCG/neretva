	...
	ggsave("results/HG03492//ncopy//plots//LILRB1.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG03492//ncopy//plots//LILRB1.html', selfcontained = F, libdir = 'results/HG03492//ncopy//plots//LILRB1')