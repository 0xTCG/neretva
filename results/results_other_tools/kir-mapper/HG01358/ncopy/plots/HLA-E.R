	...
	ggsave("results/HG01358//ncopy//plots//HLA-E.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG01358//ncopy//plots//HLA-E.html', selfcontained = F, libdir = 'results/HG01358//ncopy//plots//HLA-E')