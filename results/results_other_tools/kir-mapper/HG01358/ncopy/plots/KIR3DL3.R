	...
	ggsave("results/HG01358//ncopy//plots//KIR3DL3.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG01358//ncopy//plots//KIR3DL3.html', selfcontained = F, libdir = 'results/HG01358//ncopy//plots//KIR3DL3')