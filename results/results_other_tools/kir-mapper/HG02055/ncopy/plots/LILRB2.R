	...
	ggsave("results/HG02055//ncopy//plots//LILRB2.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG02055//ncopy//plots//LILRB2.html', selfcontained = F, libdir = 'results/HG02055//ncopy//plots//LILRB2')