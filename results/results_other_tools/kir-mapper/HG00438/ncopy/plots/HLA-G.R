	...
	ggsave("results/HG00438//ncopy//plots//HLA-G.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG00438//ncopy//plots//HLA-G.html', selfcontained = F, libdir = 'results/HG00438//ncopy//plots//HLA-G')