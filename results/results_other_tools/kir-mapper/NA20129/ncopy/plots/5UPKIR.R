	...
	ggsave("results/NA20129//ncopy//plots//5UPKIR.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/NA20129//ncopy//plots//5UPKIR.html', selfcontained = F, libdir = 'results/NA20129//ncopy//plots//5UPKIR')