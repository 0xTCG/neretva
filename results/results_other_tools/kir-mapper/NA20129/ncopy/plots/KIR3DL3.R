	...
	ggsave("results/NA20129//ncopy//plots//KIR3DL3.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/NA20129//ncopy//plots//KIR3DL3.html', selfcontained = F, libdir = 'results/NA20129//ncopy//plots//KIR3DL3')