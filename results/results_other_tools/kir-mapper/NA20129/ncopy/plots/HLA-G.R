	...
	ggsave("results/NA20129//ncopy//plots//HLA-G.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/NA20129//ncopy//plots//HLA-G.html', selfcontained = F, libdir = 'results/NA20129//ncopy//plots//HLA-G')