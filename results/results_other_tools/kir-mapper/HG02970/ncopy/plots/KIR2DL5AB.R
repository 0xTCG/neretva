	...
	setwd('results/HG02970//ncopy//plots/')
	...
	ggsave("results/HG02970//ncopy//plots//KIR2DL5AB.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG02970//ncopy//plots//KIR2DL5AB.html', selfcontained = F, libdir = 'results/HG02970//ncopy//plots//KIR2DL5AB')