	...
	ggsave("results/HG00621//ncopy//plots//KIR2DL4.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG00621//ncopy//plots//KIR2DL4.html', selfcontained = F, libdir = 'results/HG00621//ncopy//plots//KIR2DL4')