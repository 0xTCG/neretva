	...
	ggsave("results/HG00621//ncopy//plots//HLA-G.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG00621//ncopy//plots//HLA-G.html', selfcontained = F, libdir = 'results/HG00621//ncopy//plots//HLA-G')