	...
	setwd('results/NA18906//ncopy//plots/')
	...
	ggsave("results/NA18906//ncopy//plots//KIR2DL5AB.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/NA18906//ncopy//plots//KIR2DL5AB.html', selfcontained = F, libdir = 'results/NA18906//ncopy//plots//KIR2DL5AB')