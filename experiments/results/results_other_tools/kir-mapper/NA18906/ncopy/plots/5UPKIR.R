	...
	ggsave("results/NA18906//ncopy//plots//5UPKIR.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/NA18906//ncopy//plots//5UPKIR.html', selfcontained = F, libdir = 'results/NA18906//ncopy//plots//5UPKIR')