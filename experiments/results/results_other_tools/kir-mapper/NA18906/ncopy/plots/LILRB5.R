	...
	ggsave("results/NA18906//ncopy//plots//LILRB5.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/NA18906//ncopy//plots//LILRB5.html', selfcontained = F, libdir = 'results/NA18906//ncopy//plots//LILRB5')