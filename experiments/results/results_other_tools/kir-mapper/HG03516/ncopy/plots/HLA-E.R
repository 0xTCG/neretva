	...
	ggsave("results/HG03516//ncopy//plots//HLA-E.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG03516//ncopy//plots//HLA-E.html', selfcontained = F, libdir = 'results/HG03516//ncopy//plots//HLA-E')