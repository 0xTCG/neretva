	...
	setwd('results/HG03516//ncopy//plots/')
	...
	ggsave("results/HG03516//ncopy//plots//KIR2DL5AB.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG03516//ncopy//plots//KIR2DL5AB.html', selfcontained = F, libdir = 'results/HG03516//ncopy//plots//KIR2DL5AB')