	...
	ggsave("results/NA19240//ncopy//plots//HLA-G.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/NA19240//ncopy//plots//HLA-G.html', selfcontained = F, libdir = 'results/NA19240//ncopy//plots//HLA-G')