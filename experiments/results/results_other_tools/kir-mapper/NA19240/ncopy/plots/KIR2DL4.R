	...
	ggsave("results/NA19240//ncopy//plots//KIR2DL4.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/NA19240//ncopy//plots//KIR2DL4.html', selfcontained = F, libdir = 'results/NA19240//ncopy//plots//KIR2DL4')