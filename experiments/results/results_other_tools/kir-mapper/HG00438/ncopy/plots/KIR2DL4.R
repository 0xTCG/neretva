	...
	ggsave("results/HG00438//ncopy//plots//KIR2DL4.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG00438//ncopy//plots//KIR2DL4.html', selfcontained = F, libdir = 'results/HG00438//ncopy//plots//KIR2DL4')