	...
	ggsave("results/NA19030//ncopy//plots//5UPKIR.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/NA19030//ncopy//plots//5UPKIR.html', selfcontained = F, libdir = 'results/NA19030//ncopy//plots//5UPKIR')