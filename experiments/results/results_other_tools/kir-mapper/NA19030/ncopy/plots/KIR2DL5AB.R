	...
	setwd('results/NA19030//ncopy//plots/')
	...
	ggsave("results/NA19030//ncopy//plots//KIR2DL5AB.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/NA19030//ncopy//plots//KIR2DL5AB.html', selfcontained = F, libdir = 'results/NA19030//ncopy//plots//KIR2DL5AB')