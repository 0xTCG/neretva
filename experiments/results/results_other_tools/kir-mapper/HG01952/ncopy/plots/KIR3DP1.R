	...
	ggsave("results/HG01952//ncopy//plots//KIR3DP1.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG01952//ncopy//plots//KIR3DP1.html', selfcontained = F, libdir = 'results/HG01952//ncopy//plots//KIR3DP1')