	...
	ggsave("results/HG00673//ncopy//plots//LILRB1.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG00673//ncopy//plots//LILRB1.html', selfcontained = F, libdir = 'results/HG00673//ncopy//plots//LILRB1')