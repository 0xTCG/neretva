	...
	ggsave("results/HG03486//ncopy//plots//KIR3DP1.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG03486//ncopy//plots//KIR3DP1.html', selfcontained = F, libdir = 'results/HG03486//ncopy//plots//KIR3DP1')