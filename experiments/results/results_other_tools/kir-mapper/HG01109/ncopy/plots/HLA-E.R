	...
	ggsave("results/HG01109//ncopy//plots//HLA-E.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG01109//ncopy//plots//HLA-E.html', selfcontained = F, libdir = 'results/HG01109//ncopy//plots//HLA-E')