	...
	ggsave("results/HG01928//ncopy//plots//HLA-E.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/HG01928//ncopy//plots//HLA-E.html', selfcontained = F, libdir = 'results/HG01928//ncopy//plots//HLA-E')