	...
	setwd('results/NA20129//ncopy//plots/')
	...
	ggsave("results/NA20129//ncopy//plots//KIR2DL5AB.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, 'results/NA20129//ncopy//plots//KIR2DL5AB.html', selfcontained = F, libdir = 'results/NA20129//ncopy//plots//KIR2DL5AB')